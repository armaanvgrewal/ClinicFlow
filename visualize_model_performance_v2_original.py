"""
ClinicTriage Model Performance Visualization - Original v2 Retrained
=====================================================================

Comprehensive visualization of model performance for triage_model_mimic_v2_original.pkl
...
print("Model: triage_model_mimic_v2_original.pkl (Retrained)")
print("=" * 70)
...
try:
    ...
    print("   Please run retrain_model_original_v2.py first.")
    exit(1)

# Try to load metadata
metadata = None
try:
    with open('model_metadata_mimic_v2_original.pkl', 'rb') as f:
...
print("\n" + "=" * 70)
print("METRIC SUMMARY - RETRAINED MODEL")
print("=" * 70)
...
# Create summary text
oob_display = f"{oob_score:.1%}" if oob_score else "N/A"
summary_text = f"""
MODEL PERFORMANCE SUMMARY
═════════════════════════════════════
Model: triage_model_mimic_v2_original.pkl

Overall Metrics
───────────────
  Overall Accuracy:     {overall_accuracy:.1%}
  Weighted F1 Score:    {weighted_f1:.1%}
  OOB Score:            {oob_display}
...
# Save figures with DIFFERENT names for the retrained model
output_file = 'model_performance_v2_original_complete.png'
output_file_hires = 'model_performance_v2_original_complete_hires.png'
...
print("\n" + "=" * 70)
print("🎯 VISUALIZATION COMPLETE - RETRAINED MODEL")
print("=" * 70)
